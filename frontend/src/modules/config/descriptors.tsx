...
export const configEntities: ConfigEntityDescriptor[] = [
  taxonomyDescriptor(
    ...
    "Categories",
    "Category",
    "The top level of the skill taxonomy. Every skill belongs to one.",
  ),
  skillsDescriptor,
  taxonomyDescriptor(
    "departments",
    "Departments",
    "Department",
    "Used to tag people and to target classes and daily quizzes.",
  ),
  rankedDescriptor(
    "seniority-levels",
    "Seniority levels",
    "Seniority level",
    "How far into a career someone is. Ranked so reports can order them.",
  ),
  taxonomyDescriptor(
    "job-positions",
    "Job positions",
    "Job position",
    "The role someone holds, independent of their department.",
  ),
  rankedDescriptor(
    "employee-levels",
    "Employee levels",
    "Employee level",
    "The internal grade ladder. Ranked so reports can order them.",
  ),
]
