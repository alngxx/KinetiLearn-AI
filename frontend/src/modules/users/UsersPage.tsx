        ...
        {FILTERS.map((filter) => (
          <div key={filter.name} className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className="h-8 w-44 appearance-none rounded-lg border border-input bg-transparent px-2.5 py-1 text-sm transition-colors outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 dark:bg-input/30"
            >
